...
class FinalProjectUnitreeH1EnvCfg(H1FlatEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.terminations.goal_reached = DoneTerm(
            ...
            params={"goal_x": CURRICULUM_PROXY_GOAL_X, "start_x": MAP_START_POS[0]},
        )
...
class FinalProjectUnitreeH1RoughGoalBaselineEnvCfg(H1RoughEnvCfg):
    ...
    def _validate_rough_goal_baseline_cfg(self):
        ...
        if self.terminations.goal_reached.func is not custom_mdp.goal_reached:
            raise ValueError("Rough-goal baseline goal_reached must use goal_reached.")
...
class FinalProjectUnitreeH1FastWalkEnvCfg(FinalProjectUnitreeH1RoughGoalBaselineEnvCfg):
    ...
    Uses simple goal_reached termination. Speed-gated goal_progress requires the robot
